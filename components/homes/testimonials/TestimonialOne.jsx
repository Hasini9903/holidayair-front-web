...
import BackendRequest, { serverUrl } from "../../../app/api/BackendRequest";
export default function TestimonialOne() {
  ...
  const fetchData = async() => {
    const response = await BackendRequest.get("review/get-list");
          ...
          <div className="col-xl-6 col-md-8 col-sm-10">
            <div className="overflow-hidden js-section-slider">
              ...
              >
                ...
                >
                  {Array.isArray(testimonials) && testimonials?.map((elm, i) => (
                    <SwiperSlide key={i} >
